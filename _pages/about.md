...
* 🎉🎉 2026-06-02: 带领本科生撰写的中国发明专利"一种基于电池时序模型的电池状态预测方法及装置"获得授权；
* 🎉🎉 2026-04-24: 带领本科生撰写的中国发明专利"一种识别扭曲文本图像的处理方法、装置、设备及介质"获得授权；
* 🎉🎉 2025-06-24: 带领本科生撰写的中国发明专利"一种污水处理工艺时序数据预测方法、装置、设备及介质"获得授权；
...
*Publications will be updated here. Please visit [Google Scholar](https://scholar.google.com/citations?view_op=list_works&hl=en&hl=en&user=AocaxXwAAAAJ&pagesize=80&sortby=pubdate) for the full list.*
